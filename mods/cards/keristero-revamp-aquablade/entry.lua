...
sword.hit_particle_animation_state = "WATER"
sword.blade_particle_animation_state = "WATER"
sword.apply_color_effect = function(node,progress)
    local r = 20
    local g = math.floor(150-progress*100)
    local b = math.floor(255-progress*20)
