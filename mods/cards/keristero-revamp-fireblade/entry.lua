...
sword.element = Element.Fire
sword.cut_animation_state = "LONG"
sword.hit_particle_animation_state = "FIRE"
sword.blade_particle_animation_state = "FIRE"
sword.apply_color_effect = function(node,progress)
    local r = math.floor(255-progress*20)
    local g = math.floor(150-progress*150)
    local b = 20
