...
sword.element = Element.Wood
sword.cut_animation_state = "LONG"
sword.hit_particle_animation_state = "WOOD"
sword.blade_particle_animation_state = "WOOD"
sword.apply_color_effect = function(node,progress)
    local r = math.floor(20+progress*512)
    local g = math.floor(220-progress*200)
    local b = 30
