...
local sword = {
    ...
    fallback_attack_pattern_center=sword_attack_positions.furthest_tile,
    ...
    cut_texture = Engine.load_texture(_folderpath .. "/cuts/cut_colonel.png"),
    cut_animation = _folderpath .. "/cuts/cut_colonel.animation",
    cut_animation_state = "Z",
...
sword.card_create_action = function(user,props)
    ...
    action:add_anim_action(2,function ()
        ...
        print('spawning visual artifact')
        battle_helpers.spawn_visual_artifact(user,spell_center_tile,sword.cut_texture,sword.cut_animation,sword.cut_animation_state,spell_center_tile:x(),spell_center_tile:y(),false)
